...
def main():
    ...
    print("-----------------------------------")
    meeting_participants = input("What are the emails of participants (other than you) in the meeting?\n")
    ...
    meeting_strategy_agent = agents.meeting_stratergy_agent()
    ...
    meeting_strategy_task = tasks.meeting_stratergy_task(meeting_strategy_agent, meeting_context, meeting_objective)
    summary_and_briefing_task = tasks.summarising_and_briefing_task(summary_and_briefing_agent, meeting_context, meeting_objective)
